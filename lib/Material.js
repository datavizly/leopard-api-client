...
class Material {
   ...
   *
   * @method
   * @path [GET] /Materials/{id}/account
   * @name Material#getAccount
  ...
  getAccount(id, opts, cb) {
    ...
    const path = utils.buildPath('/Materials/{id}/account', {
      id: id,
    });
   ...
   *
   * @method
   * @path [GET] /Materials/{id}/weibo
   * @name Material#getWeibo
   * @param {string} id - Material id
   * @param {object|function|*} [opts] - Optional params
   * @param {boolean} [opts.refresh] - refresh
   * @param {function} [cb] - Callback function
  ...
  getWeibo(id, opts, cb) {
    ...
    const path = utils.buildPath('/Materials/{id}/weibo', {
      id: id,
    });
   ...
   *
   * @method
   * @path [GET] /Materials/{id}/department
   * @name Material#getDepartment
   * @param {string} id - Material id
   * @param {object|function|*} [opts] - Optional params
   * @param {boolean} [opts.refresh] - refresh
   * @param {function} [cb] - Callback function
  ...
  getDepartment(id, opts, cb) {
    ...
    const path = utils.buildPath('/Materials/{id}/department', {
      id: id,
    });
   ...
   *
   * @method
   * @path [GET] /Materials/{id}/group
   * @name Material#getGroup
   * @param {string} id - Material id
   * @param {object|function|*} [opts] - Optional params
   * @param {boolean} [opts.refresh] - refresh
   * @param {function} [cb] - Callback function
  ...
  getGroup(id, opts, cb) {
    ...
    const path = utils.buildPath('/Materials/{id}/group', {
      id: id,
    });
   ...
   *
   * @method
   * @path [PATCH] /Materials
   * @name Material#patchOrCreate
   * @param {object|function|*} [opts] - Optional params
   * @param {object} [opts.data] - Model instance data
   * @param {function} [cb] - Callback function
   */
   ...
   *
   * @method
   * @path [POST] /Materials/replaceOrCreate
   * @name Material#replaceOrCreateViaPost
   * @param {object|function|*} [opts] - Optional params
   * @param {object} [opts.data] - Model instance data
   * @param {function} [cb] - Callback function
   */
  replaceOrCreateViaPost(opts, cb) {
    ...
    const path = '/Materials/replaceOrCreate';
   ...
   *
   * @method
   * @path [POST] /Materials/upsertWithWhere
   * @name Material#upsertWithWhere
   * @param {object|function|*} [opts] - Optional params
  ...
  upsertWithWhere(opts, cb) {
    ...
    const path = '/Materials/upsertWithWhere';
  ...
  exists(id, cb) {
    ...
    const path = utils.buildPath('/Materials/{id}/exists', {
      id: id,
    });
   ...
   *
   * @method
   * @path [HEAD] /Materials/{id}
   * @name Material#existsViaHead
   * @param {string} id - Model id
   * @param {function} [cb] - Callback function
   */
  existsViaHead(id, cb) {
    ...
    const path = utils.buildPath('/Materials/{id}', {
      id: id,
    });
   ...
   *
   * @method
   * @path [GET] /Materials/{id}
   * @name Material#findById
   * @param {string} id - Model id
   * @param {object|function|*} [opts] - Optional params
   ...
   *
   * @method
   * @path [PUT] /Materials/{id}
   * @name Material#replaceById
   * @param {string} id - Model id
   * @param {object|function|*} [opts] - Optional params
   * @param {object} [opts.data] - Model instance data
   * @param {function} [cb] - Callback function
   ...
   *
   * @method
   * @path [DELETE] /Materials/{id}
   * @name Material#deleteById
   * @param {string} id - Model id
   * @param {function} [cb] - Callback function
   */
  deleteById(id, cb) {
   ...
   *
   * @method
   * @path [PATCH] /Materials/{id}
   * @name Material#patchAttributes
   * @param {string} id - Material id
   * @param {object|function|*} [opts] - Optional params
   * @param {object} [opts.data] - An object of model property name/value pairs
   * @param {function} [cb] - Callback function
   ...
   *
   * @method
   * @path [POST] /Materials/{id}/replace
   * @name Material#replaceByIdViaPost
   * @param {string} id - Model id
   * @param {object|function|*} [opts] - Optional params
   * @param {object} [opts.data] - Model instance data
   * @param {function} [cb] - Callback function
  ...
  replaceByIdViaPost(id, opts, cb) {
    ...
    const path = utils.buildPath('/Materials/{id}/replace', {
      id: id,
    });
   ...
   *
   * @method
   * @path [GET] /Materials/findOne
   * @name Material#findOne
   * @param {object|function|*} [opts] - Optional params
   * @param {string} [opts.filter] - Filter defining fields, where, include, order, offset, and limit - must be a JSON-encoded string ({"something":"value"})
   * @param {function} [cb] - Callback function
   */
   ...
   *
   * @method
   * @path [POST] /Materials/update
   * @name Material#updateAll
   * @param {object|function|*} [opts] - Optional params
   * @param {string} [opts.where] - Criteria to match model instances
   * @param {object} [opts.data] - An object of model property name/value pairs
   * @param {function} [cb] - Callback function
   ...
   *
   * @method
   * @path [POST] /Materials/change-stream
   * @name Material#createChangeStreamViaPost
   * @param {object|function|*} [opts] - Optional params
  ...
  createChangeStreamViaPost(opts, cb) {
    ...
    const path = '/Materials/change-stream';
   ...
   *
   * @method
   * @path [GET] /Materials/change-stream
   * @name Material#createChangeStream
   * @param {object|function|*} [opts] - Optional params
   * @param {string} [opts.options] - options
   * @param {function} [cb] - Callback function
   */
