...
class Verification {
   ...
   *
   * @method
   * @path [GET] /Verifications/{id}/account
   * @name Verification#getAccount
  ...
  getAccount(id, opts, cb) {
    ...
    const path = utils.buildPath('/Verifications/{id}/account', {
      id: id,
    });
   ...
   *
   * @method
   * @path [PATCH] /Verifications
   * @name Verification#patchOrCreate
   * @param {object|function|*} [opts] - Optional params
   * @param {object} [opts.data] - Model instance data
   * @param {function} [cb] - Callback function
   */
   ...
   *
   * @method
   * @path [PUT] /Verifications
   * @name Verification#replaceOrCreate
   * @param {object|function|*} [opts] - Optional params
   * @param {object} [opts.data] - Model instance data
   * @param {function} [cb] - Callback function
   */
   ...
   *
   * @method
   * @path [POST] /Verifications/replaceOrCreate
   * @name Verification#replaceOrCreateViaPost
   * @param {object|function|*} [opts] - Optional params
   * @param {object} [opts.data] - Model instance data
   * @param {function} [cb] - Callback function
   */
  replaceOrCreateViaPost(opts, cb) {
    ...
    const path = '/Verifications/replaceOrCreate';
   ...
   *
   * @method
   * @path [POST] /Verifications/upsertWithWhere
   * @name Verification#upsertWithWhere
   * @param {object|function|*} [opts] - Optional params
  ...
  upsertWithWhere(opts, cb) {
    ...
    const path = '/Verifications/upsertWithWhere';
   ...
   *
   * @method
   * @path [GET] /Verifications/{id}/exists
  ...
  exists(id, cb) {
    ...
    const path = utils.buildPath('/Verifications/{id}/exists', {
      id: id,
    });
   ...
   *
   * @method
   * @path [HEAD] /Verifications/{id}
   * @name Verification#existsViaHead
   * @param {string} id - Model id
   * @param {function} [cb] - Callback function
   */
  existsViaHead(id, cb) {
    ...
    const path = utils.buildPath('/Verifications/{id}', {
      id: id,
    });
   ...
   *
   * @method
   * @path [GET] /Verifications/{id}
   * @name Verification#findById
   * @param {string} id - Model id
   * @param {object|function|*} [opts] - Optional params
   ...
   *
   * @method
   * @path [PUT] /Verifications/{id}
   * @name Verification#replaceById
   * @param {string} id - Model id
   * @param {object|function|*} [opts] - Optional params
   * @param {object} [opts.data] - Model instance data
   * @param {function} [cb] - Callback function
   ...
   *
   * @method
   * @path [DELETE] /Verifications/{id}
   * @name Verification#deleteById
   * @param {string} id - Model id
   * @param {function} [cb] - Callback function
   */
  deleteById(id, cb) {
   ...
   *
   * @method
   * @path [PATCH] /Verifications/{id}
   * @name Verification#patchAttributes
   * @param {string} id - Verification id
   * @param {object|function|*} [opts] - Optional params
   * @param {object} [opts.data] - An object of model property name/value pairs
   * @param {function} [cb] - Callback function
   ...
   *
   * @method
   * @path [POST] /Verifications/{id}/replace
   * @name Verification#replaceByIdViaPost
   * @param {string} id - Model id
   * @param {object|function|*} [opts] - Optional params
   * @param {object} [opts.data] - Model instance data
   * @param {function} [cb] - Callback function
  ...
  replaceByIdViaPost(id, opts, cb) {
    ...
    const path = utils.buildPath('/Verifications/{id}/replace', {
      id: id,
    });
   ...
   *
   * @method
   * @path [GET] /Verifications/findOne
   * @name Verification#findOne
   * @param {object|function|*} [opts] - Optional params
   * @param {string} [opts.filter] - Filter defining fields, where, include, order, offset, and limit - must be a JSON-encoded string ({"something":"value"})
   * @param {function} [cb] - Callback function
   */
  findOne(opts, cb) {
    ...
    const path = '/Verifications/findOne';
   ...
   *
   * @method
   * @path [POST] /Verifications/update
   * @name Verification#updateAll
   * @param {object|function|*} [opts] - Optional params
   * @param {string} [opts.where] - Criteria to match model instances
   * @param {object} [opts.data] - An object of model property name/value pairs
   * @param {function} [cb] - Callback function
  ...
  updateAll(opts, cb) {
    ...
    const path = '/Verifications/update';
  ...
  count(opts, cb) {
    ...
    const path = '/Verifications/count';
   ...
   *
   * @method
   * @path [POST] /Verifications/change-stream
   * @name Verification#createChangeStreamViaPost
   * @param {object|function|*} [opts] - Optional params
  ...
  createChangeStreamViaPost(opts, cb) {
    ...
    const path = '/Verifications/change-stream';
   ...
   *
   * @method
   * @path [GET] /Verifications/change-stream
   * @name Verification#createChangeStream
   * @param {object|function|*} [opts] - Optional params
   * @param {string} [opts.options] - options
   * @param {function} [cb] - Callback function
   */
   ...
   *
   * @method
   * @path [GET] /Verifications/verify-code
   * @name Verification#verifyCode
   * @param {object|function|*} [opts] - Optional params
  ...
  verifyCode(opts, cb) {
    ...
    const path = '/Verifications/verify-code';
